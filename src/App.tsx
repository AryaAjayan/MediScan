...
import { Activity, ShieldCheck, Heart, Info, Terminal, RefreshCw, Layers } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans select-none antialiased">
      ...
      <main className="flex-grow max-w-[1440px] w-full mx-auto p-4 lg:p-6 grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        
        {/* LEFT COLUMN: Patient Visualization Stage / Controls (Col-Span 5) */}
        <section className="lg:col-span-5 space-y-6 lg:sticky lg:top-[80px]">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-lg space-y-4">
            ...
            {/* Pathological descriptor overlay notification */}
            ...
            {/* Quick action: Reset and match settings */}
            {inferenceResult && (
          ...
          {/* Attribution Depth Config Panel */}
          <GradCamVisualizer
        ...
        {/* RIGHT COLUMN: Workbench Core Launcher, Sandbox API / Swagger, Metrics (Col-Span 7) */}
        <section className="lg:col-span-7 space-y-6">
          
          {/* Main Controls bench, selector libraries, upload targets, results metrics */}
          <ModelBench
          ...
          {/* Live Swagger, Python scripts generators and Docker Container supervisions */}
          <FastApiSandbox
      ...
      {/* 3. Global Footer copyright and notes */}
